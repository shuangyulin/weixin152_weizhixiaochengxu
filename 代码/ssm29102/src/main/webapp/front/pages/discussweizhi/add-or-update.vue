	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussweizhi`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																												...
																																																																												if(this.ruleForm.id){
					await this.$api.update(`discussweizhi`, this.ruleForm);
				}else{
					await this.$api.add(`discussweizhi`, this.ruleForm);
				}
				uni.setStorageSync('discussweizhiCleanType',true);
